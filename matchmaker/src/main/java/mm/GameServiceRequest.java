...
public class GameServiceRequest {
    ...
    public String create(int playerCount) {
        //String uri = "http://34.227.95.123:20021/game/create";
        String uri = "http://165.227.239.245:8090/game/create";
    ...
    public String start(long gameId) {
        // String uri = "http://34.227.95.123:20021/game/start";
        String uri = "http://165.227.239.245:8090/game/start";
        UriComponentsBuilder builder = UriComponentsBuilder.fromHttpUrl(uri)
